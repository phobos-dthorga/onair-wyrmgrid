...
HTTPS keeps certificate and hostname verification enabled. On Windows the SDK
loads server-authentication roots from the operating-system trust store rather
than depending on a separately installed or potentially stale OpenSSL CA file.
