...
formatting, build #23 dependency-bootstrap side-effect reconciliation,
safe-patch survival after formatter rejection, path normalization, root-wide and traversal
