...
- `locales/en-AU.json` is source catalogue version 23.
...
authors must review the version 23 catalogue, update `source_catalog_version`,
...
Source catalogue version 23 adds Forge extension-development actions and their
protected recovery wording. Source catalogue version 22 adds audio-codec package inspection, lifecycle,
native-code trust, and destructive-removal wording. Source catalogue version 21
adds audio-provider package inspection, selection,
...
explicit historical route-weather and Atlas wording. Source catalogue version 16 adds planned route ETA, forecast-validity,
...
added the protected weather-provider
