...
- `locales/en-AU.json` is source catalogue version 15.
...
authors must review the version 15 catalogue, update `source_catalog_version`,
...
Source catalogue version 15 adds the Atlas RADAR history controls, timestamp,
motion-safe static state, no-coverage key, and Dispatch route-weather
presentation. Version 14 adds Atlas continuity choices, protected last-view
