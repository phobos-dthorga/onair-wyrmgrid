...
- `locales/en-AU.json` is source catalogue version 22.
...
authors must review the version 22 catalogue, update `source_catalog_version`,
...
Source catalogue version 22 adds audio-codec package inspection, lifecycle,
